...
<template>
  <div class="component">
    <div class="component-left">
      <div :class="{ 'menu-item': true, 'active-menu-item': activeMenu === 'com' }" @click="activeMenu = 'com'">
        <svg
          class="icon"
      ...
      <div :class="{ 'menu-item': true, 'active-menu-item': activeMenu === 'tree' }" @click="activeMenu = 'tree'">
        <svg
          class="icon"
          viewBox="0 0 1024 1024"
          version="1.1"
      ...
      <div :class="{ 'menu-item': true, 'active-menu-item': activeMenu === 'history' }" @click="activeMenu = 'history'">
        <svg
          class="icon"
      ...
      <!-- <div :class="{ 'menu-item': true, 'active-menu-item': activeMenu === 'schema' }" @click="activeMenu = 'schema'">
        <svg
          t="1626450925255"
          class="icon"
          viewBox="0 0 1024 1024"
