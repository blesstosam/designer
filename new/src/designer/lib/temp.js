...
var genGlobalCtx = function genGlobalCtx(state) {
  var _state$immutable = state.immutable,
      immutable = _state$immutable === void 0 ? {} : _state$immutable,
      _state$mutable = state.mutable,
      mutable = _state$mutable === void 0 ? {} : _state$mutable;
  store.initState(mutable);
  var res = {};
  Object.keys(mutable).forEach(function (k) {
    // theme 必须是响应式的 每次使用 ctx.theme 要动态从 store 获取
    Object.defineProperty(res, k, {
      get: function get() {
        return store.getState(k);
      }
    });
    var upK = k[0].toUpperCase() + k.slice(1);

    res["on".concat(upK, "Change")] = function (cb) {
      store.onStateChange(k, cb);
    };

    res["set".concat(upK)] = function (val) {
      store.setState(k, val);
    };
  });
  return Object.assign(res, cloneDeep_1(immutable));
}; // 业务api

var genAppCtx = function genAppCtx(api) {
  return api;
}; // 给设计器使用mock用

var genMockCtx = function genMockCtx(platform) {
  if (platform !== 'pc' && platform !== 'h5') throw new Error("platform \u4E3A 'pc' \u6216 'h5'");
  var theme = 'black';
  var skins = [{
    name: '深邃黑',
    color: '#232c37',
    theme: 'black',
    menuSelectedBgColor: '#4680ff'
  }, {
    name: '梦幻紫',
    color: '#292a39',
    theme: 'purple',
    ...
    color: '#2e68aa',
    theme: 'blue',
    menuSelectedBgColor: '#87bbfe'
  }, {
    name: '薄暮红',
    color: '#db4d6d',
    theme: 'dustRed',
    menuSelectedBgColor: '#8f2444'
  }, {
    name: '落日橘',
    color: '#ed784a',
    theme: 'sunsetOrange',
    menuSelectedBgColor: '#a13d22'
  }, {
    name: '青柠绿',
    color: '#86c166',
    theme: 'lime',
    menuSelectedBgColor: '#457532'
  }, {
    name: '拂晓蓝',
    color: '#2ea9df',
    theme: 'daybreakBlue',
    menuSelectedBgColor: '#106291'
  }, {
    name: '丁香紫',
    color: '#6a4c9c',
    theme: 'goldenPurple',
    menuSelectedBgColor: '#9B82BE'
  }, {
    name: '系统主题',
    theme: 'systemTheme',
    menuSelectedBgColor: '#4680ff'
  ...
  var user = {
    avatar: 'https://www.qycloud.com.cn/api/user/avatar/avatardownload/120/120/weilei/1620729945',
  ...
  var server = {
    fileio: 'https://www.qycloud.com.cn/',
    iot: 'http://121.199.65.152:29088',
    microservices: {
      organization: 'https://www.qycloud.com.cn//service_org/'
    },
    organization: 'https://www.qycloud.com.cn//service_org/',
    root: 'qycloud.com.cn',
    sta: 'https://www.qycloud.com.cn/',
    storeView: 'https://www.qycloud.com.cn/',
    ws: 'wss://ws.qpaas.com/ws',
  ...
  return {
    ...
    app: genAppCtx({
      // fields: cloneDeep(store.fields),
      // config: cloneDeep(store.configure),
      // data: cloneDeep(store.originData),
      fields: {},
      config: {
        app_button: {},
        app_info: {},
      ...
      onFieldValueChanged: function onFieldValueChanged() {},
      onSlaveFieldValueChanged: function onSlaveFieldValueChanged() {},
      onFieldPropertyChanged: function onFieldPropertyChanged() {},
      onSlaveFieldPropertyChanged: function onSlaveFieldPropertyChanged() {},
      onSlaveTablePropertyChanged: function onSlaveTablePropertyChanged() {},
      getFormData: function getFormData() {},
      getSlaveFormData: function getSlaveFormData() {},
      getFieldValue: function getFieldValue() {},
      getSlaveFieldValue: function getSlaveFieldValue() {},
      setFieldValue: function setFieldValue() {},
      setSlaveFieldValue: function setSlaveFieldValue() {},
      getFieldProperty: function getFieldProperty() {},
      setFieldProperty: function setFieldProperty() {},
      setSlaveFieldProperty: function setSlaveFieldProperty() {},
      getSlaveProperty: function getSlaveProperty() {},
      setSlaveTableProperty: function setSlaveTableProperty() {},
...
export { AsyncApp, AsyncComponent, FetchLoader, ModuleLoader, event, genAppCtx, genGlobalCtx, genMockCtx, loadComponent, _loadCss as loadCss, setPublicPath, store };